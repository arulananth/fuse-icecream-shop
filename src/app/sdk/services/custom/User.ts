...
export class UserApi extends BaseLoopBackApi {
  ...
  /**
   * Trovare un elemento correlato in base all'ID per accessTokens.
   *
   * @param {any} id User id
   *
   * @param {any} fk Chiave esterna per accessTokens
   *
  ...
  /**
   * Eliminare un elemento correlato in base all'ID per accessTokens.
   *
   * @param {any} id User id
   *
   * @param {any} fk Chiave esterna per accessTokens
  ...
  /**
   * Aggiornare un elemento correlato in base all'ID per accessTokens.
   *
   * @param {any} id User id
   *
   * @param {any} fk Chiave esterna per accessTokens
  ...
  /**
   * Crea una nuova istanza di questo modello in accessTokens.
   *
   * @param {any} id User id
   *
   * @param {object} data Request data.
  ...
  /**
   * Elimina tutti i accessTokens di questo modello.
   *
   * @param {any} id User id
   *
   * @returns {object} An empty reference that will be
   ...
   *   from the server.
   *
   * Il corpo della risposta contiene proprietà del AccessToken creato all'accesso.
