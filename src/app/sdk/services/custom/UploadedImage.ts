...
/**
 * Api services for the `UploadedImage` model.
 */
@Injectable()
export class UploadedImageApi extends BaseLoopBackApi {
   ...
   * <em>
   * (The remote method definition does not provide any description.
   * This usually means the response is a `UploadedImage` object.)
   * </em>
   */
  ...
  public getFiles(container: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UploadedImages/:container/files";
    let _routeParams: any = {
      container: container
    };
    let _postBody: any = {};
  ...
  public getFile(container: any, file: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UploadedImages/:container/files/:file";
    let _routeParams: any = {
      container: container,
      file: file
    };
   ...
   *  - `result` – `{object}` - 
   */
  public upload(container: any, productId: number, file: any = {}, req: any = {}, res: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UploadedImages/:container/upload";
    let _routeParams: any = {
      container: container
    };
    let _postBody: any = {
  ...
  public download(container: any, file: any, req: any = {}, res: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UploadedImages/:container/download/:file";
    let _routeParams: any = {
      container: container,
      file: file
    };
